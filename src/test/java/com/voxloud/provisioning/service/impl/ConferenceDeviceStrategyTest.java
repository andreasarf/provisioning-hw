...
@SpringJUnitConfig({ConferenceDeviceStrategy.class, JacksonAutoConfiguration.class})
...
class ConferenceDeviceStrategyTest {

    @Autowired
    private ConferenceDeviceStrategy strategy;
    @MockitoSpyBean
    private ProvisioningProperties provisioningProperties;

    @Test
    void givenNoOverrideFragment_whenConstructFile_thenShouldReturnStandardProvisioning() throws Exception {
        // arrange
    ...
    @Test
    void givenOverrideFragment_whenConstructFile_thenShouldReturnOverriddenProvisioning() throws Exception {
        // arrange
        Device device = new Device();
        device.setMacAddress("00:00:00:00:00:12");
        device.setUsername("walter");
